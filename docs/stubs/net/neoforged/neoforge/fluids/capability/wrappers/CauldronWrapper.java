Compiled from "CauldronWrapper.java"
public class net.neoforged.neoforge.fluids.capability.wrappers.CauldronWrapper implements net.neoforged.neoforge.fluids.capability.IFluidHandler {
  public net.neoforged.neoforge.fluids.capability.wrappers.CauldronWrapper(net.minecraft.world.level.Level, net.minecraft.core.BlockPos);
  public int getTanks();
