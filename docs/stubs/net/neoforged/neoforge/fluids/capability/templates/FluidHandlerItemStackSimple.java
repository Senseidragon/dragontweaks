Compiled from "FluidHandlerItemStackSimple.java"
public class net.neoforged.neoforge.fluids.capability.templates.FluidHandlerItemStackSimple implements net.neoforged.neoforge.fluids.capability.IFluidHandlerItem {
  public net.neoforged.neoforge.fluids.capability.templates.FluidHandlerItemStackSimple(java.util.function.Supplier<net.minecraft.core.component.DataComponentType<net.neoforged.neoforge.fluids.SimpleFluidContent>>, net.minecraft.world.item.ItemStack, int);
